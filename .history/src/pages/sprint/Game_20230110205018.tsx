  ...
  return (
    <div className="game bg-greyligt">
      <div className="flex flex-col items-center justify-center wrapper-calc">
        <div style={{background: `conic-gradient(#2b788b ${270}deg, #c3dce3 0deg)`}} className="circular-progess before:w-[485px] before:h-[485px] relative md:w-[500px] md:h-[500px] rounded-[50%] flex items-center justify-center">
