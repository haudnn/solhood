                  ...
                  <div className="pr-5">
                    ...
                    <div className="flex items-center justify-between mb-10 md:justify-start md:gap-x-6">
                      {levels.map((level, index) => (
                        <div key={level.id} className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-greendesign cursor-pointer">
                      ...
                      <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-yellowdesign cursor-pointer">
                        <span className="text-base font-bold text-yellowdesign">
                          A2
                        </span>
                      </div>
                      <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-orangedesign cursor-pointer">
                        <span className="text-base font-bold text-orangedesign">
                          B1
                        </span>
                      </div>
                      <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-reddesign cursor-pointer">
                        <span className="text-base font-bold text-reddesign">
                          B2
                        </span>
                      </div>
                      <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-pinkdesign cursor-pointer">
                        <span className="text-base font-bold text-pinkdesign">
                          C1
                        </span>
                      </div>
                      <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-cyandesign cursor-pointer">
