...
const Result = () => {
  return (
    <div className="result bg-greyligt">
      <div className="max-w-[1300px] m-auto md:wrapper-calc">
                ...
                <div className="p-10 bg-white rounded-lg shadow-lg">
                  <div className="grid">
                    <div className="row">
                      ...
                      <div className="col l-6 c-12">
                        <div>
                          <p className="text-2xl text-center md:mb-3 md:text-4xl font-dela md:text-start">Your Sprint</p>
                          <p className="text-base font-semibold text-center md:mb-3 text-greydark md:text-start">
                            You did pretty good!
                          </p>
                          <div className="flex items-center justify-center mx-3 md:justify-between gap-x-5 md:gap-x-0 md:mx-0">
                            <div>
                              <div
                                style={{
