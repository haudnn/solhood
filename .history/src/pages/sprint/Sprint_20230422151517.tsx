                    ...
                    <div className="flex items-center justify-between mb-10 md:justify-start md:gap-x-6">
                      {levels.map((level, index) => (
                        <div
                          ...
                          key={level.id}
                          className={`${currentLevel === level.id ? `back-[${level.backgroudColor}]` :  "" } flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 cursor-pointer ${level.borderColor}`}
                        >
                          <span
