            ...
            <div className="row">
              ...
              <div className="col l-8 c-12">
                <div className="flex flex-col justify-center w-full h-full">
                    ...
                    <div className="flex items-center justify-between mb-10 md:justify-start md:gap-x-6">
                      {levels.map((level, index) => (
                        <div
                          ...
                          style={{
                            backgroundColor:
                              currentLevel === level.id ? level.backgroudColor : "",
                          }}
                          cursor-pointer
                          className={` flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 cursor-pointer ${level.borderColor}`}
                        >
                          <span
                            className={`text-base font-bold text-greendesign  ${ currentLevel === level.id ? "text-white" : level.textColor}`}
                          >
                            {level.name}
                          </span>
                        </div>
                  ...
                  <Link to="sprint/game" className="flex items-center justify-center md:justify-start">
