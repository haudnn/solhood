  ...
  return (
    <div className="game bg-greyligt">
      <div className="flex flex-col items-center justify-center px-5 md:wrapper-calc md:px-0">
        <div style={{background: `conic-gradient(#2b788b ${270}deg, #c3dce3 0deg)`}} className="circular-progess before:w-[322px] before:h-[322px] w-[337px] h-[337px] md:before:w-[485px] md:before:h-[485px] relative md:w-[500px] md:h-[500px] rounded-[50%] flex justify-center">
