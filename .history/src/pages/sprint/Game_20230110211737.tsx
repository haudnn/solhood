  ...
  return (
    <div className="game bg-greyligt">
      <div className="flex flex-col items-center justify-center px-5 md:wrapper-calc md:px-0">
        <div ref={componentRef } style={{background: `conic-gradient(#2b788b ${270}deg, #c3dce3 0deg)`}} className={`circular-progess before:w-328px] before:h-328px] w-[336px] h-[336px] md:before:w-[485px] md:before:h-[485px] relative md:w-[500px] md:h-[500px] rounded-[50%] flex items-center justify-center`}>
