                ...
                <div className="p-10 bg-white rounded-lg shadow-lg">
                  <div className="grid">
                    <div className="row">
                      ...
                      <div className="col l-6 c-12">
                        <div>
                          <p className="mb-1 text-2xl text-center md:mb-3 md:text-4xl font-dela md:text-start">Your Sprint</p>
                          <p className="mb-3 text-base font-semibold text-center text-greydark md:text-start">
                            You did pretty good!
                          </p>
