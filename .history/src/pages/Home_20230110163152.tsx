              ...
              <div className="row">
                <div className="col l-6">
                  <div className="md:translate-y-[50%]">
                    <p className="text-5xl text-center font-dela">
                      Increase your vocabulary
                    </p>
                    <p className="py-10 font-semibold text-lg text-greydark max-w-[400px] text-center">
                      Traditional and new effective approaches to word study
                    </p>
                    <button className="text-center w-[140px] h-[44px] bg-cyanlight rounded-full text-cyandark font-semibold text-base flex items-center justify-center">
                      <a href="/">Textbook →</a>
                    </button>
                  </div>
                </div>
