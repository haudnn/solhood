            ...
            <div className="col l-6">
              <div className="p-10 bg-white rounded-lg shadow-lg">
                    ...
                    <div className="col l-6">
                      <div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div>
                            <div style={{ background: `conic-gradient(#639b6d ${360}deg, #c3dce3 0deg)`, }} className="circular-progess-small relative w-[120px] h-[120px] rounded-[50%] flex items-center justify-center">
                              <div className="relative">
                                <div className="p-2 text-center">
                                  <p className="text-base font-semibold">
                                    40/
                ...
                <div className="flex items-center justify-center gap-x-[30px]">
                    ...
                    <div>
                        <a href="/" className="inline-block px-10 py-3 text-xl font-bold rounded-full bg-cyanlight">
                            <span className="font-bold text-cyandark">
                                Go to textbook
                            </span>
                        </a>
                    </div>
