                  ...
                  <div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-between">
                           ...
                           <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-[green]">
                             <span className="text-base font-bold text-green">A2</span>
                           </div>
                           <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-[green]">
                             <span className="text-base font-bold text-green">B1</span>
                           </div>
                           <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-[green]">
                             <span className="text-base font-bold text-green">B2</span>
                           </div>
                           <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-[green]">
                             <span className="text-base font-bold text-green">C1</span>
                           </div>
                           <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border-2 border-[green]">
                             <span className="text-base font-bold text-green">C2</span>
                           </div>
                        </div>
                    </div>
                  </div>
