                    ...
                    <div className="row">
                      <div className="col l-6">
                        <div className="flex items-start mb-4 gap-x-3">
                          <p className="text-3xl font-dela">I know</p>
                        ...
                        <div>
                            <ul>
                                <li className="flex items-center flex-start gap-x-5">
                                    <div className="flex items-center justify-center w-[40px] h-[40px] bg-greyligt">
                                        <img src={play} alt="" className="object-cover w-full h-full"/>
                                    </div>
                                    <div>
                                        <span>lone</span>
                                        <span>{"-"} solitaire</span>
