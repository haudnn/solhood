    ...
    <div className="result bg-greyligt">
      <div className="max-w-[1300px] m-auto wrapper-calc">
        <div className="flex items-center justify-center w-full h-full">
          <div className="grid">
            <div className="row">
              <div className="col l-6 max-h-[370px]">
              ...
              <div className="col l-6 max-h-[370px] overflow-hidden">
                <div className="p-10 bg-white rounded-lg shadow-lg">
                  <div className="grid">
                    <div className="row">
                      <div className="col l-6">
                        <div className="flex items-start mb-4 gap-x-3">
                          ...
                          <div className="px-2 mt-2 rounded-md bg-cyanlight">
                            <span className="text-sm font-semibold text-cyandark">
                              15 words
                            </span>
                          </div>
                        </div>
                        <ul className="overflow-y-scroll max-h-[256px]">
