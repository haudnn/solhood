                        ...
                        <div className="row">
                            ...
                            <div className="col l-8">
                                <div>
                                    ...
                                    <p className='text-base font-semibold text-greydark'>Trains the skill of fast translation. You have to choose if the translation corresponds to the suggested word.</p>
                                </div>
                            </div>
                        </div>
                    </div>
