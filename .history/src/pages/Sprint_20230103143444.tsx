                        ...
                        <div className="row">
                            ...
                            <div className="col l-8">
                                <div>
                                    ...
                                    <p className='font-semibold text-greymedium'>Trains the skill of fast translation. You have to choose if the translation corresponds to the suggested word.</p>
                                </div>
                            </div>
                        </div>
                    </div>
