    ...
    <div className="game bg-greyligt">
      <div className="flex flex-col items-center justify-center wrapper-calc">
        <div className="flex flex-col items-center justify-center">
          <div className="transition group text-cyandark hover:bg-cyandark hover:text-white mb-5 flex flex-col items-center justify-center w-[148px] h-[148px] rounded-[50%] border-4 border-solid border-cyandark cursor-pointer">
            <img src={playIcon} alt="" className="block object-cover group-hover:hidden w-[48px] h-[48px]" />
            <img src={playIconHover} alt="" className="hidden object-cover group-hover:block" />
          ...
          <div className="mb-10 text-cyandark cursor-pointer py-[20px] px-[10px] rounded-full bg-cyanlight flex items-center justify-center">
            {/* If have the result */}
