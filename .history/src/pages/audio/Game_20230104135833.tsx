    ...
    <div className="game bg-greyligt">
      <div className="flex flex-col items-center justify-center wrapper-calc">
        <div className="flex flex-col items-center justify-center">
          <div className="group text-cyandark hover:bg-cyandark hover:text-white mb-5 flex flex-col items-center justify-center w-[148px] h-[148px] rounded-[50%] border-4 border-solid border-cyandark cursor-pointer">
