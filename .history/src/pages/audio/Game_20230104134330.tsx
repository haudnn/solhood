      ...
      <div className="flex flex-col items-center justify-center wrapper-calc">
          <div className='flex flex-col items-center justify-center'>
            ...
            <div className='flex my-10 gap-x-5'>
              ...
              <div className='hover:border-greydark hover:text-greydark cursor-pointer p-[14px] rounded-full border-4 border-solid border-greyicon flex items-center justify-center'>
                <span className='text-lg font-bold text-greyicon'>correct</span>
              </div>
              <div className='cursor-pointer p-[14px] rounded-full border-4 border-solid border-greyicon flex items-center justify-center'>
                <span className='text-lg font-bold text-greyicon'>selon laquelle</span>
              </div>
              <div className='cursor-pointer p-[14px] rounded-full border-4 border-solid border-greyicon flex items-center justify-center'>
                <span className='text-lg font-bold text-greyicon'>citer</span>
              </div>
              <div className='cursor-pointer p-[14px] rounded-full border-4 border-solid border-greyicon flex items-center justify-center'>
                <span className='text-lg font-bold text-greyicon'>nourriture</span>
              </div>
            </div>
          </div>
      </div>
