                ...
                <div className="p-10 bg-white rounded-lg shadow-lg">
                  <div className="grid">
                    <div className="row">
                      ...
                      <div className="col l-6">
                        <div>
                          <p className="mb-3 text-2xl font-dela">Your Audio-Call</p>
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              <div
                                style={{
                                  background: `conic-gradient(#945069 ${360}deg, #f2d4dc 0deg)`,
                                }}
                                  ...
                                  <div className="p-2 text-center ">
                                    ...
                                    <div className="flex flex-col items-center">
                                      <div className="flex items-center justify-center">
                                        <AiFillHeart className="inline-block w-full h-full"></AiFillHeart>
                                        <p className="text-3xl font-dela">4</p>
                                      </div>
