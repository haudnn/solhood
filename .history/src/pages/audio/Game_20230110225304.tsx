...
const Game = () => {
  ...
  return (
    <div className="py-10 game bg-greyligt md:py-0">
      <div className="flex flex-col items-center justify-center md:wrapper-calc">
        <div className="flex flex-col items-center justify-center">
          {isResulted ? (
            <div className="flex flex-col items-center md:mb-5">
              <div
                ...
                className="transition bg-center bg-cover bg-no-repeat md:w-[148px] md:h-[148px] w-[100px] h-[100px] rounded-[50%] cursor-pointer"
              ></div>
          ...
          <div className="flex flex-col my-5 md:my-10 gap-x-5 md:flex-row gap-y-3 md:gap-y-0">
            <div className="hover:border-greydark hover:text-greydark text-greyicon cursor-pointer md:p-[14px] rounded-full border-4 border-solid border-greyicon flex items-center justify-center py-3 px-[13px]">
              <span className="text-base font-bold md:text-lg">prêt hypothécaire</span>
            </div>
            <div className="hover:border-greydark hover:text-greydark text-greyicon cursor-pointer md:p-[14px] rounded-full border-4 border-solid border-greyicon flex items-center justify-center py-3 px-[13px]">
              <span className="text-base font-bold md:text-lg">correct</span>
            </div>
            {/* The word was selected */}
            <div className=" text-pinkdark cursor-pointer md:p-[14px] rounded-full border-4 border-solid border-pinkdark flex items-center justify-center py-3 px-[13px]">
              <span className="text-base font-bold md:text-lg">selon laquelle</span>
            </div>
            {/* <div className="hover:border-greydark hover:text-greydark text-greyicon cursor-pointer md:p-[14px] rounded-full border-4 border-solid border-greyicon flex items-center justify-center py-3 px-[13px]">
              <span className="text-base font-bold md:text-lg">selon laquelle</span>
            </div> */}
            <div className="hover:border-greydark hover:text-greydark text-greyicon cursor-pointer md:p-[14px] rounded-full border-4 border-solid border-greyicon flex items-center justify-center py-3 px-[13px]">
              <span className="text-base font-bold md:text-lg">citer</span>
            </div>
            {/* The word correct */}
            <div className=" text-cyandark cursor-pointer md:p-[14px] rounded-full border-4 border-solid border-cyandark flex items-center justify-center py-3 px-[13px]">
              <span className="text-base font-bold md:text-lg">nourriture</span>
            </div>
            {/* <div className="hover:border-greydark hover:text-greydark text-greyicon cursor-pointer md:p-[14px] rounded-full border-4 border-solid border-greyicon flex items-center justify-center py-3 px-[13px]">
              <span className="text-base font-bold md:text-lg">nourriture</span>
            </div> */}
          </div>
          <div className="md:mb-10 text-cyandark cursor-pointer md:p-[15px] rounded-full bg-cyanlight flex items-center justify-center px-5 py-3">
            {/* If have the result */}
            {/* <span className="text-base font-bold md:text-lg">Next</span> */}
            <span className="text-base font-bold md:text-lg">I don't know</span>
          </div>
