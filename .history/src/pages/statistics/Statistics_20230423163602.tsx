            ...
            <div className="grid">
              <div className="row">
                <div className="col l-5 c-12">
                  <div className="p-5 mb-5 bg-white shadow-lg md:p-10 rounded-xl md:mb-0">
                    <div>
                      <h4 className="mb-1 text-2xl text-center text-black md:text-start md:mb-2 font-dela">
                        All-time statistics
                      </h4>
                      <span className="block text-base font-semibold text-center text-greydark md:text-start">
                    ...
                    <div className="flex md:gap-x-5 gap-x-3">
                      ...
                      <div>
                        <div className="flex items-start mb-2 md:gap-x-3 gap-x-2">
                        ...
                        <p className="text-sm font-semibold md:text-base text-greydark ">
                ...
                <div className="col l-7 c-12 ">
                  <div className="h-full p-3 bg-white shadow-lg md:p-5 rounded-xl ">
