                ...
                <div className="col l-8">
                  <div>
                    ...
                    <div>
                        ...
                        <div>
                           <div className="flex items-center justify-center w-[44px] h-[44px] rounded-[50%] border-solid border border-[green]">
                             <span className="text-lg font-bold text-green">A1</span>
                           </div>
                        </div>
                    </div>
                  </div>
