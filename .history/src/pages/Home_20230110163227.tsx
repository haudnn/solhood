        ...
        <div className="app-container">
          <div className="p-10">
            <div className="grid">
              <div className="row">
                <div className="col l-6">
                  <div className="md:translate-y-[50%] flex items-center flex-col md:items-start">
                    <p className="text-5xl text-center font-dela md:text-start">
                      Increase your vocabulary
                    </p>
                    <p className="py-10 font-semibold text-lg text-greydark max-w-[400px] text-center md:text-start">
