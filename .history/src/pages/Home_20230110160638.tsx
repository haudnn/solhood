...
const Home = () => {
  return (
    <>
      <div className="relative wrapper bg-greyligt">
            ...
            <div className="row">
              <div className="col l-6">
                <div className='flex flex-col items-center justify-center md:block'>
                  ...
                  <h1 className="mt-6 font-dela text-5xl leading-[60px] text-center">
                    Learning and teaching online, made easy.
                  </h1>
                  <p className="mt-6 max-w-[400px] font-semibold text-greydark text-lg text-center">
