    ...
    <>
            ...
            <div className="row">
              <div className="col l-6 c-12">
                <div className="flex flex-col items-center justify-center md:block">
                  ...
                  <h1 className="mt-6 font-dela text-5xl md:leading-[60px] text-center md:text-start">
                    Learning and teaching online, made easy.
                  </h1>
                  <p className="mt-6 text-lg font-semibold text-center text-greydark md:text-start">
      ...
      <section className="bg-greyligt">
        <div className="app-container">
          <div className="px-10 pt-10 md:p-10 ">
            <div className="grid">
              <div className="row">
                <div className="col l-6">
        ...
        <div className="py-[80px]">
          <div className="grid">
            <div className="row">
              ...
              <div className="col l-6">
                <div className="flex flex-col items-center justify-center px-5 md:px-0 md:items-start">
                  <p className="text-3xl text-center font-dela md:text-start md:text-5xl">
