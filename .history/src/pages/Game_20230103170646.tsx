  ...
  return (
    <div className="game bg-greyligt">
      <div className="flex items-center justify-center wrapper-calc">
        <div className="w-[500px] h-[500px] rounded-[50%] border border-solid border-cyanlight flex items-center justify-center">
        <div className="w-[122px] h-[122px] rouded-[50%] bg-cyandark "></div>
          <div>
