            ...
            <div className="row">
              ...
              <div className="col l-7 c-12">
                <div className="py-5 pl-4 pr-10 md:py-10">
                  ...
                  {isShowButtons && (
                    <div className="flex flex-col md:items-center md:gap-x-5 md:flex-row">
                      <button className="py-3 px-5  rounded-[100px] bg-greendesign">
                        <span className="text-sm font-semibold text-white">
                          Add to learned
                        </span>
                      </button>
                      <button className="py-3 px-5  rounded-[100px] bg-secondorangedesign">
    ...
    <div className="col l-4 c-12">
      <div className="bg-white rounded-[14px] shadow-lg mb-6">
        ...
        <div className="p-5 md:p-10">
          ...
          {isShowButtons && (
            <div>
              <button className="py-3 px-5 rounded-[100px] bg-greendesign inline-block mb-2">
                <span className="text-sm font-semibold text-white">
                  Add to learned
                </span>
              </button>
