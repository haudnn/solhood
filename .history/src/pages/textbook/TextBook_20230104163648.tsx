            ...
            <div className="row">
              ...
              <div className="col l-6">
                <div className="flex items-center justify-end w-full h-full gap-x-[10px]">
                    <div className="flex items-center justify-start pr-10 rounded-xl gap-x-2 bg-pinklight">
                        <img src={textbookSneaker} alt="" className="object-cover" />
                        <span className="text-base font-bold text-pinkdark">Sprint</span>
                    </div>
                    <div className="flex items-center justify-start pr-10 rounded-xl gap-x-2 bg-cyanlight">
                        <img src={textbookAudio} alt="" className="object-cover" />
                        <span className="text-base font-bold text-cyandark">Audio-Call</span>
                    </div>
                    <div className="p-4 bg-greyligt rounded-xl">
                        <AiOutlineSetting className="text-greyicon"></AiOutlineSetting>
                    </div>
                </div>
              </div>
            </div>
