  ...
  return (
    <div className="md:pt-10 pt-5 textbook bg-greyligt pb-[100px] px-5 md:px-0">
      <div className="flex flex-col items-center max-w-[1180px] m-auto">
        ...
        <div className="my-10 overflow-x-hidden overflow-y-hidden max-w-[350px] md:flex md:items-center md:justify-center md:max-w-full md:overflow-auto ">
          <div className="flex items-center justify-center overflow-x-hidden overflow-y-hidden gap-x-10 w-fit whitespace-nowrap">
