              ...
              <div className="col l-4">
                <div className="bg-white rounded-[14px] shadow-lg mb-6">
                  <div
                    ...
                    className="relative pt-[77%] bg-no-repeat bg-contain rounded-tl-[14px] rounded-tr-[14px]"
                  ></div>
              ...
              <div className="col l-4">
                <div className="bg-white rounded-[14px] shadow-lg mb-6">
                  <div
                    ...
                    className="relative h-[250px] w-full bg-no-repeat bg-contain rounded-tl-[14px] rounded-tr-[14px]"
                  ></div>
                  <div className="p-[30px]">
                    <div className="text-2xl text-black font-dela">
                      <p className="text-black">remark</p>
