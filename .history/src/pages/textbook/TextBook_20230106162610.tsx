              ...
              <div className="col l-4">
                <div className="bg-white rounded-[14px] shadow-lg">
                  <div
                    ...
                    className="relative w-full h-[250px] max-h-[250px] bg-center bg-no-repeat bg-cover rounded-tl-[14px] rounded-tr-[14px]"
                  ></div>
                  <div className="p-[30px]">
                    ...
                    <div className="pb-3 border-b-2 border-solid border-greymedium">
                      <span className="text-base font-semibold text-justify text-black">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consectetur quas tenetur quia ipsam velit commodi dicta consequatur nam ab itaque porro reprehenderit, hic autem dolorum possimus eius iusto laboriosam suscipit!
                      </span>
                    </div>
                  </div>
                </div>
