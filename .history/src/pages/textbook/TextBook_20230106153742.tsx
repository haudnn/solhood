            ...
            <div className="row">
              ...
              <div className="col l-6">
                <div className="flex items-center justify-end w-full h-full gap-x-[10px] relative">
                  ...
                  <div className="flex items-center justify-center w-10 h-10 rounded-md shadow-lg cursor-pointer bg-greyligt">
                    <AiOutlineSetting className="w-5 h-5 text-greyicon"></AiOutlineSetting>
                  </div>
                  <div className="absolute p-5 bg-white rounded-[14px] shadow-lg top-14">
                      <div>
                          <div className="flex items-center gap-x-[10px] mb-1">
                              <input checked={checkedList[0].checked} onChange={handleChecked} type="checkbox" id="0" name="0" value="0"/>
                              <label htmlFor="0" className={`font-semibold ${checkedList[0].checked ? "text-black" : "text-[#828282]"}`}>Show words in a list</label>
                          </div>
                          <div className="flex items-center gap-x-[10px] mb-1">
                              <input checked={checkedList[1].checked}  onChange={handleChecked} type="checkbox" id="1" name="1" value="1"/>
                              <label htmlFor="1"  className={`font-semibold ${checkedList[1].checked ? "text-black" : "text-[#828282]"}`}>Display the 'Add' and 'Remove' buttons</label>
                          </div>
                      </div>
                    </div>
                </div>
                      ...
                      <div className="col l-7">
                        <div className="py-10 pl-4 pr-10">
                            ...
                            <div className="pb-3 border-b-2 border-solid border-greymedium">
                                <span className="text-base font-semibold text-black">To remark is to say something.</span>
                            </div>
                            <div className="pt-3 pb-5 ">
                                <p className="font-medium text-greydark">The teacher remarked on how quickly the students were learning.</p>
                            </div>
                            <div className="flex items-center gap-x-5">
                                <button className="py-2 px-3 rounded-[100px] bg-greendesign">
                                    <span className="text-sm font-semibold text-white">Add to learned</span>
                                </button>
                                <button className="py-2 px-3 rounded-[100px] bg-secondorangedesign">
                                    <span className="text-sm font-semibold text-orangedesign">Remove from dictionary</span>
                                </button>
                            </div>
                        </div>
                      </div>
