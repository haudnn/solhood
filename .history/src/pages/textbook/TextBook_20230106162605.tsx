                  ...
                  <div className="p-[30px]">
                    ...
                    <div className="pb-3 border-b-2 border-solid border-greymedium">
                      <span className="text-base font-semibold text-justify text-black">
                        Lorem ipsum, dolor sit amet hello adipisicing elit. Consectetur quas tenetur quia ipsam velit commodi dicta consequatur nam ab itaque porro reprehenderit, hic autem dolorum possimus eius iusto laboriosam suscipit!
                      </span>
                    </div>
                  </div>
                </div>
