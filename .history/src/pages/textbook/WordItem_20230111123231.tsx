            ...
            <div className="row">
              <div className="col l-5 c-12">
                <div
                  ...
                  className="relative w-full max-h-[137px] md:max-h-full bg-center bg-no-repeat bg-cover rounded-tl-lg rounded-tr-lg aspect-square md:rounded-bl-lg md:rounded-tr-none"
                ></div>
              </div>
