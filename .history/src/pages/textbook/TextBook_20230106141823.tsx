            ...
            <div className="row">
              ...
              <div className="col l-6">
                <div className="flex items-center justify-end w-full h-full gap-x-[10px]">
                  ...
                  <div className="relative flex items-center justify-center w-10 h-10 rounded-md cursor-pointer bg-greyligt">
                    <AiOutlineSetting className="w-5 h-5 text-greyicon"></AiOutlineSetting>
                    <div className="absolute p-5 bg-white rounded-[14px] shadow-md h-[100px] top-10">
                      <div>
                          <div>
                            <input type="checkbox" id="words" name="words"/>
                            <label htmlFor="words">Show words in a list</label>
                          </div>
                          <div>
                            <input type="checkbox" id="display" name="display"/>
                            <label htmlFor="display">Display the "Add" and "Remove" buttons</label>
                          </div>
                      </div>
                    </div>
                  </div>
