              ...
              <div className="col l-6">
                <div className="flex items-center justify-end w-full h-full gap-x-[10px] relative">
                  ...
                  <div className="absolute p-5 bg-white rounded-[14px] shadow-lg top-14">
                      <div>
                        {dataCheckBoxList.map((data) => (
                              <div className="flex items-center gap-x-[10px] mb-1">
                              <input checked={checked === data.name ? true: false} onChange={handleChecked} type="checkbox" id={data.name} name={data.name}/>
                              <label htmlFor={data.name} className="font-semibold">{data.text}</label>
                            </div>
                        ))}
                      </div>
                    </div>
