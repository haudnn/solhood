...
const TextBook = () => {
  ...
  return (
    <div className="md:pt-10 pt-5 textbook bg-greyligt pb-[100px]">
      <div className="flex flex-col items-center w-[1180px] m-auto">
        <div className="w-full p-5 bg-white rounded-lg shadow-md ">
          <div className="grid">
            <div className="row">
              <div className="col l-6 c-12">
                <div className="flex items-center w-full h-full mb-10 md:mb-0">
              ...
              <div className="col l-6 c-12">
                <div
                  ref={ref}
                  className="flex items-center md:justify-end w-full h-full gap-x-[10px] relative "
                >
                  ...
                  <div
                    ...
                    className={`flex items-center justify-center w-10 h-10 rounded-md cursor-pointer ${isSettings ? "bg-cyandark" : "bg-greyligt"}`}
                  >
