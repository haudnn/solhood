...
const TextBook = () => {
  ...
  return (
    <div className="pt-10 textbook bg-greyligt pb-[100px]">
      <div className="flex flex-col items-center justify-center w-[1180px] m-auto">
        <div className="w-full p-5 bg-white rounded-lg shadow-md ">
          <div className="grid">
            <div className="row">
              ...
              <div className="col l-6">
                <div  ref={ref} className="flex items-center justify-end w-full h-full gap-x-[10px] relative ">
