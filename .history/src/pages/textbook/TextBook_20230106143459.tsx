                  ...
                  <div className="absolute p-5 bg-white rounded-[14px] shadow-lg top-14">
                      <div>
                          ...
                          <div className="flex items-center gap-x-[10px]">
                            <input checked={checked} onChange={handleChecked}  type="checkbox" id="display" name="display"/>
                            <label htmlFor="display" className="font-semibold text-greydark">Display the "Add" and "Remove" buttons</label>
                          </div>
                      </div>
                    </div>
                </div>
