...
const TextBook = () => {
  ...
  return (
    <div className="md:pt-10 pt-5 textbook bg-greyligt pb-[100px] px-5 md:px-0">
          ...
          <div className="grid">
            <div className="row">
              ...
              <div className="col l-6 c-12">
                ...
                >
                  <div className="flex items-center justify-start pr-5 cursor-pointer md:pr-10 rounded-xl gap-x-2 bg-pinklight">
                    <img
                      src={textbookSneaker}
                      alt=""
                  ...
                  <div className="flex items-center justify-start pr-2 cursor-pointer md:pr-10 rounded-xl gap-x-2 bg-cyanlight">
                  <div className="md:w-[34px] md:h-[34px]">
                    <img src={textbookAudio} alt="" className="object-cover md:w-full md:h-full" />
                  </div>
                    <span className="text-sm font-bold md:text-base text-cyandark">
                      Audio-Call
                    </span>
                  </div>
                  <div
                    onClick={handleShowSettings}
                    className={`flex items-center justify-center h-full aspect-square max-w-10 max-h-10 rounded-md cursor-pointer ${isSettings ? "bg-cyandark" : "bg-greyligt"}`}
                  >
                    <AiOutlineSetting className={`w-5 h-5 ${isSettings ? "text-white" : "text-greyicon"} t`}></AiOutlineSetting>
                  </div>
                  {isSettings && (
