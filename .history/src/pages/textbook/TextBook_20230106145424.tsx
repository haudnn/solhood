...
const dataCheckBoxList: Data[] = [
  {
    name: "words",
    text: "Show words in a list",
  },
  {
    name: "display",
    text: "Display the 'Add' and 'Remove' buttons",
  },
];
const TextBook = () => {
                  ...
                  <div className="absolute p-5 bg-white rounded-[14px] shadow-lg top-14">
                      <div>
                          <div className="flex items-center gap-x-[10px] mb-1">
                              <input checked={!checked} onChange={handleChecked} type="checkbox" id="words" name="words"/>
                              <label htmlFor="words" className={`font-semibold`}>Show words in a list</label>
                          </div>
                          <div className="flex items-center gap-x-[10px] mb-1">
                              <input checked={checked} onChange={handleChecked} type="checkbox" id="dislay" name="dislay"/>
                              <label htmlFor="dislay" className={`font-semibold`}>Display the 'Add' and 'Remove' buttons</label>
                          </div>
                      </div>
                    </div>
                </div>
