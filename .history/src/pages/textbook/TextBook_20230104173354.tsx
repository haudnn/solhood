                    ...
                    <div className="row">
                      ...
                      <div className="col l-7">
                        <div className="p-10">
                            ...
                            <div className="pb-3 border-b border-solid border-greymedium">
                                <span className="text-base font-semibold text-black">To remark is to say something. - Remarquer, c'est dire quelque chose</span>
                            </div>
                            <div>
                                <p>The teacher remarked on how quickly the students were learning. L'enseignant a noté la rapidité avec laquelle les élèves apprenaient.</p>
                            </div>
                        </div>
                      </div>
                    </div>
