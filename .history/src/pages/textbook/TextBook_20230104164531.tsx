  ...
  return (
    <div className="pt-10 textbook bg-greyligt">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="my-10 flex items-center justify-center gap-x-[14px]">
            <div className="flex items-center justify-center pb-[10px] gap-x-2">
                <span className="text-2xl font-dela">A1</span>
                <div className="px-2 py-1 rounded-md bg-greendesign">
                    <span className="text-xs text-white">Easy</span>
                </div>
            </div>
        </div>
      </div>
