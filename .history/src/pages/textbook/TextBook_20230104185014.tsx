                      ...
                      <div className="col l-7">
                        <div className="p-10">
                            ...
                            <div className="pt-3 pb-5 ">
                                <p className="font-medium text-greydark">The teacher remarked on how quickly the students were learning. L'enseignant a noté la rapidité avec laquelle les élèves apprenaient.</p>
                            </div>
