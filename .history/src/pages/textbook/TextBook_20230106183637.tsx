    ...
    <div className="pt-10 textbook bg-greyligt pb-[100px]">
      <div className="flex flex-col items-center w-[1180px] m-auto">
        ...
        <div className="flex items-center justify-center pt-10 gap-x-6">
          <div className="w-[48px] h-[48px] flex items-center justify-center rounded-[50%] border-2 border-solid border-cyandark">
              <span className="text-base font-semibold text-cyandark">1</span>
          </div>
        </div>                   
      </div>
    </div>
