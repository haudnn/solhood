                    ...
                    <div className="row">
                      ...
                      <div className="col l-7">
                        <div className="p-10">
                            ...
                            <div className="pt-3 ">
                                <p className="font-semibold text-greydark">The teacher remarked on how quickly the students were learning. L'enseignant a noté la rapidité avec laquelle les élèves apprenaient.</p>
                            </div>
                        </div>
                      </div>
                    </div>
