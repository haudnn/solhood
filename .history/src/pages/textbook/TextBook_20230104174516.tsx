                    ...
                    <div className="row">
                      <div className="col l-5">
                        <div
                          ...
                          className="relative w-full h-full bg-center bg-no-repeat bg-cover rounded-bl-md rounded-tl-md"
                        ></div>
                      </div>
                      <div className="col l-7">
                        <div className="p-10">
                            ...
                            <div className="pt-3 pb-5 ">
                                <p className="text-greydark">The teacher remarked on how quickly the students were learning. L'enseignant a noté la rapidité avec laquelle les élèves apprenaient.</p>
                            </div>
