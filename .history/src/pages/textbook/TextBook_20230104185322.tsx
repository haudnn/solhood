                  ...
                  <div className="grid">
                    <div className="row">
                      ...
                      <div className="col l-7">
                        <div className="py-10 pr-10 pl-[28px]">
                            ...
                            <div className="pt-3 pb-5 ">
                                <p className="font-medium break-words text-greydark whitespace-nowrap">The teacher remarked on how quickly the students were learning.</p>
                            </div>
