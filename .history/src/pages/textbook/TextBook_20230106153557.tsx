                  ...
                  <div className="absolute p-5 bg-white rounded-[14px] shadow-lg top-14">
                      <div>
                          <div className="flex items-center gap-x-[10px] mb-1">
                              ...
                              <label htmlFor="0" className={`font-semibold ${checkedList[0].checked ? "text-black" : "text-greyligt"}`}>Show words in a list</label>
                          </div>
                          <div className="flex items-center gap-x-[10px] mb-1">
                              <input checked={checkedList[1].checked}  onChange={handleChecked} type="checkbox" id="1" name="1" value="1"/>
                              <label htmlFor="1"  className={`font-semibold ${checkedList[1].checked ? "text-black" : "text-greyligt"}`}>Display the 'Add' and 'Remove' buttons</label>
                          </div>
                      </div>
                    </div>
                </div>
