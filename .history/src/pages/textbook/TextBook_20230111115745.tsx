  ...
  return (
    <div className="md:pt-10 pt-5 textbook bg-greyligt pb-[100px] px-5 md:px-0">
      <div className="flex flex-col items-center max-w-[1180px] m-auto">
        ...
        <div className="flex items-center justify-center w-full my-10 overflow-x-scroll flex-nowrap whitespace-nowrap gap-x-10">
          ...
          <div className="w-[100px] cursor-pointer flex items-center justify-center pb-[10px] gap-x-2">
