...
const TextBook = () => {
  ...
  const handleChecked = (e:any) => {
    ...
    console.log(newList)
    // newList[+value].checked = !newList[+value].checked
    setChecked(newList);
  }
  console.log(checked)
  return (
                  ...
                  <div className="absolute p-5 bg-white rounded-[14px] shadow-lg top-14">
                      <div>
                          <div className="flex items-center gap-x-[10px] mb-1">
                              <input onChange={handleChecked} type="checkbox" id="1" name="1" value="1"/>
                              <label htmlFor="1" className={`font-semibold`}>Show words in a list</label>
                          </div>
                          <div className="flex items-center gap-x-[10px] mb-1">
                              <input onChange={handleChecked} type="checkbox" id="2" name="2" value="2"/>
