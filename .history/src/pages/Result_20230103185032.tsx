                    ...
                    <div className="col l-6">
                      <div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div>
                            <div style={{ background: `conic-gradient(#2b788b ${360}deg, #c3dce3 0deg)`, }} className="circular-progess-small relative w-[120px] h-[120px] rounded-[50%] flex items-center justify-center">
                              <div className="relative">
                                <div className="text-center">
                                  <p className="text-base font-semibold">
                                    40/
