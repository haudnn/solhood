          ...
          <div className="row">
            <div className="col c-4 md:hidden">
              <div className="flex items-center h-10 cursor-pointer">
                { 
                !isOpen ?   <BsJustifyLeft onClick={handleOpen} className="w-6 h-6"></BsJustifyLeft> : <AiOutlineClose onClick={handleOpen} className="w-6 h-6"></AiOutlineClose>
                }
              </div>
              <div className={`nav_ani ${isOpen ? "unhide-nav" :  "hide-nav"}`}> 
                <div className="fixed top-[71px] bottom-0 left-0 right-0 z-50 w-full max-w-full bg-white">
