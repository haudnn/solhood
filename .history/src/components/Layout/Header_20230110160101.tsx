        ...
        <div className="grid">
          <div className="row">
            ...
            <div className="col l-6 c-4">
              <div className="flex items-center md:gap-x-[60px]">
                <div className="w-full h-full text-center line before:border-r-0 md:before:border-r-2">
                  <a href="/" className="block text-lg text-black font-dela leading-[40px] md:leading-none">
                    Solhood
                  </a>
                </div>
