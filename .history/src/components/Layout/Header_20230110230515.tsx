...
const Header = () => {
  ...
  return (
    <header className="py-[18px] md:py-5 border-b border-solid border-[grey-dark] bg-greyligt flex justify-center">
          ...
          <div className="row">
            ...
            <div className="col l-6 c-4">
              <div className="flex justify-end">
                <div className="flex items-center mr-5 md:gap-x-3 gap-x-1">
